...
@IonicPage()
@Component({
  selector: 'page-filter-forma2',
  templateUrl: 'filter-forma2.html',
})
export class CRMPregledUgovoraFilterForma2Page extends BasePage {
  parametriupita={
                      action:0,
                       skladisteid:null
                      ,skladistenaziv:''
  ...
  prikazi(){
    ...
    if( this.parametriupita.robaid==null && this.parametriupita.KupUgovoriVrsteId==null && this.parametriupita.klmasterrobaid==null && this.parametriupita.naziv == ''){
      ...
      this.navCtrl.push('CRMPregledUgovoraLista2Page', this.parametriupita);
