...
@IonicPage()
@Component({
  selector: 'page-ugovori-s-dobavljacima-lista',
  templateUrl: 'lista.html'
})
export class CRMUgovoriSDobavljacimaListaPage extends BasePage {
  items: any[] = [];
  itemsoriginal: any []= [];
  val;
  ...
  openDetalji(item) {
    this.navCtrl.push('CRMUgovoriSDobavljacimaDetaljiPage', item);
    // let dataDef: ICore.IData = {
    //   "queries": [
    //     {
    //     "query": "spMob_UgovoriSaKupcima",
