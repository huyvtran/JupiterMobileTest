...
@IonicPage()
@Component({
  selector: 'page-ugovori-s-dobavljacima-filter-forma',
  templateUrl: 'filter-forma.html',
})
export class CRMUgovoriSDobavljacimaFilterFormaPage extends BasePage {
  parametriupita={
                      action:0,
                       skladisteid:null
                      ,skladistenaziv:''
  ...
  prikazi(){
    ...
    if( this.parametriupita.partneriid==null && this.parametriupita.KupUgovoriVrsteId==null){
      ...
      this.navCtrl.push('CRMUgovoriSDobavljacimaListaPage', this.parametriupita);
