...
import { IonicPage, ModalController, AlertController, NavController, PopoverController } from 'ionic-angular';
...
@Component({
  selector: 'page-crm-analizakupca-filterforma2',
  templateUrl: 'filterforma2.html'
})
export class CRMAnalizaKupcaFilerForma2Page extends BasePage {
  isEnabled = false;
  parametriupita: any = {
    action: 0,
  ...
  constructor(public modalCtrl: ModalController, public alertCtrl: AlertController, public storage: Storage, public navCtrl: NavController, public popoverCtrl: PopoverController) {
    super();
    this.storage.get('jm_crm_analizakupcafilterforma2_parametriupita').then(data => {
      if (data) {
  ...
  izracunaj() {
    if (this.parametriupita.objektanalize == '' || this.parametriupita.partneriid == null || this.parametriupita.datumod == '' || this.parametriupita.datumdo == '') {
      ...
      console.log("Klik izracunaj 22", this.parametriupita.datumod);
  ...
  spremiParametreUpita() {
    this.storage.set('jm_crm_analizakupcafilterforma2_parametriupita', this.parametriupita);
  }
...
popover.onDidDismiss((data) => {
    if (data != null) 
    {
        ...
        // this.parametriupita.datumod = data.start;
        // this.parametriupita.datumod2 = data.start;
        // this.parametriupita.datumdo = data.end;
        // this.parametriupita.datumdo2 = data.end;
