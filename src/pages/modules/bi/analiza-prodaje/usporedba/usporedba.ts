...
@IonicPage()
@Component({providers:[NumberFormatPipe],  selector: 'page-bi-analiza-prodaje-usporedba', templateUrl: 'usporedba.html' })
export class BiAnalizaProdajeUsporedba extends BasePage {
    ...
    constructor(public navParams: NavParams, public modalCtrl: ModalController, private provider: BiAnalizaProdajeProvider,
