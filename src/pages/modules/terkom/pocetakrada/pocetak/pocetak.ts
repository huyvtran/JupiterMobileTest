...
@IonicPage()
@Component({
  selector: 'page-terkom-pocetakrada',
  templateUrl: 'pocetak.html'
})
export class TerkomPocetakRadaPage  extends BasePage {
    ...
    private inputRefZavrsni;
  	...
  	constructor( private constantService : ConstProvider, private pocetakradaServis : TerkomPocetakRadaProvider, private loading : LoadingController) {
        super()
    }
